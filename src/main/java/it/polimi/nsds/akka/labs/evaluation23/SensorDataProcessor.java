...
public class SensorDataProcessor {
    ...
    public static void main(String[] args) {
        ...
        // Create dispatcher
        final ActorRef dispatcher = sys.actorOf(DispatcherActor.props());
        ...
        for (ActorRef sensor : sensors) {
            sensor.tell(new ConfigMsg(dispatcher), dispatcher);
        }
        ...
        // ...
        dispatcher.tell(
            new DispatchLogicMsg(DispatchLogicMsg.ROUND_ROBIN),
            ActorRef.noSender()
        );
        ...
        ActorRef faultySensor = sys.actorOf(
            TemperatureSensorFaultyActor.props(),
            "tFaulty"
        );
        sensors.add(0, faultySensor);

        // ...
        faultySensor.tell(new ConfigMsg(dispatcher), dispatcher);
