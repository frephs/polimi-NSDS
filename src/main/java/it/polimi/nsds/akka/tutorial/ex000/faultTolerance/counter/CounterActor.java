package it.polimi.nsds.akka.tutorial.ex000.faultTolerance.counter;

import akka.actor.AbstractActor;
import akka.actor.Props;
import it.polimi.nsds.akka.tutorial.ex000.counter.CounterSupervisor;
import it.polimi.nsds.akka.tutorial.ex000.counter.DataMessage;
...
public class CounterActor extends AbstractActor {
    ...
    void onMessage(DataMessage msg) throws Exception {
        if (msg.getCode() == CounterSupervisor.NORMAL_OP) {
            System.out.println(
                "I am executing a NORMAL operation...counter is now " +
                    (++counter)
            );
