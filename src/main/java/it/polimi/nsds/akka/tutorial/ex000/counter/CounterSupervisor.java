...
public class CounterSupervisor {
    ...
    public static void main(String[] args) {
        ...
        final ActorRef supervisor = sys.actorOf(
            CounterSupervisorActor.props(),
            "supervisor"
        );
        ...
        try {
            ...
            scala.concurrent.Future<Object> waitingForCounter = ask(
                supervisor,
            ...
            for (int i = 0; i < FAULTS; i++) counter.tell(
                new DataMessage(FAULT_OP),
                ActorRef.noSender()
            );
