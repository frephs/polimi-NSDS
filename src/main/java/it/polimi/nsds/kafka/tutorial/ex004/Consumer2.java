...
public class Consumer2 {
    ...
    private static final Map<String, Integer> keyCounts = new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (final ConsumerRecord<String, String> record : records) {
                ...
                keyCounts.put(record.key(), keyCounts.getOrDefault(record.key(), 0) +1);
                // this does not guarantee exactly once semantics, if a
                ...
                final ProducerRecord<String, Integer> modified_record =
                        new ProducerRecord<>(anotherTopic, record.key(), keyCounts.get(record.key())/*here we do not send the string anymore bu the keycount*/);
