package it.polimi.nsds.kafka.tutorial.ex001;
...
public class Consumer1 {
    private static final String defaultGroupId = "c1";
    private static final String defaultTopic = "ex001";
    private static final String anotherTopic = "ex001_processed";
